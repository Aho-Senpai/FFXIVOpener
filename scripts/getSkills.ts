...
function getJobSkills(JobShort: any, JobRole: any) {    
    ClearSkills();
    ToggleJobSelect();
...
function LoadJobSkills(JobShort: any) {
...
function LoadJobRoleSkills(JobRole: any) {
...
function DisplayJobSkills(JobShort: any, JobRole: any) {
...
function BuildSkillsButtons(Category: string, Path: string) {
